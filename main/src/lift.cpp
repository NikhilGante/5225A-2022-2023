...
_Task lift_task(liftMoveToTargetFn);
AsyncObj<LiftMoveToTargetParams> liftMoveToTarget("liftMoveToTarget", liftMoveToTargetFn, lift_task);

int lift_arr[5] = {1185, 1400, 1900, 2170, 2775};

void liftMoveToTargetFn(void* params){
  HANDLE_ARGS(LiftMoveToTargetParams);
  while(true){
