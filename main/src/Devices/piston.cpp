...
ObjectTracker{class_name, name}, ADIDigitalOut{port, init_state}, reversed{reversed} {
...
ObjectTracker{class_name, name}, ADIDigitalOut{port_pair, init_state}, reversed{reversed} {
