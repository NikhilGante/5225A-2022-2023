...
ObjectTracker{"Piston", name}, ADIDigitalOut{port, init_state != reversed}, reversed{reversed} {
...
ObjectTracker{"Piston", name}, ADIDigitalOut{port_pair, init_state != reversed}, reversed{reversed} {
